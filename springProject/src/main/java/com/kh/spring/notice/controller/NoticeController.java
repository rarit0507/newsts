...
public class NoticeController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Message> findById(@PathVariable int id) {	//ResponseEntity : 응답할 객체
	...
	public ResponseEntity<Message> deleteById(@PathVariable int id) {
		...
		Message responseMsg = Message.builder().data("삭제성공").message("서비스처리에 성공함").build();
